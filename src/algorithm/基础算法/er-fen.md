...
假设给出一段区间，前半部分满足某种性质，后半部分不满足某种性质，那么分界点有两个，即满足性质的最后一个res1和不满足性质的第一个res2    

如果我们想找res1，那么我们可以先找中间值mid=（l+r）/2，判断他是否满足性质，如果满足性质，那么答案就在[mid,r]之间，并且mid也有可能是答案，你们就用变量ans记录一下mid，再将l设为mid + 1之后重复找  

那么l重设之后，再找mid，如果mid不满足性质，那么答案就在[l,mid-1]之间，那么将r设为mid-1继续进行查找    

一直到l>r的时候停止查找，那么答案就是ans   
