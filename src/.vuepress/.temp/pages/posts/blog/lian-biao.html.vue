<template><div><h2 id="stack-hdu" tabindex="-1"><a class="header-anchor" href="#stack-hdu" aria-hidden="true">#</a> stack（hdu）</h2>
...
<p></p>
<h2 id="逆散列问题" tabindex="-1"><a class="header-anchor" href="#逆散列问题" aria-hidden="true">#</a> 逆散列问题</h2>
...
<h3 id="输出样例：">输出样例：</h3>
<pre>
<code>1 13 12 21 33 34 38 27 22 32</code></pre>
...
<p></p>
<h2 id="链表去重-。" tabindex="-1"><a class="header-anchor" href="#链表去重-。" aria-hidden="true">#</a> 链表去重 。</h2>
