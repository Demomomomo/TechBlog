<template><div><h2 id="cf1422c-bargain" tabindex="-1"><a class="header-anchor" href="#cf1422c-bargain" aria-hidden="true">#</a> CF1422C Bargain</h2>
<h2>题目描述</h2>
...
<h2 id="game-hdu-博弈论" tabindex="-1"><a class="header-anchor" href="#game-hdu-博弈论" aria-hidden="true">#</a> GAME （HDU）（博弈论）</h2>
